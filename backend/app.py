...
app.config['SQLALCHEMY_DATABASE_URI'] = f"sqlite:///{os.getenv('DATABASE_PATH', '/tmp/inventory.db')}"
...
def serve_spa(path):
    ...
    # If frontend build directory exists, serve static files
    ...
    # Fallback - redirect to frontend URL if configured
